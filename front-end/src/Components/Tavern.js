...
function Tavern() {
    ...
    return (
        ...
        <Modal open={openChat} onClose={onCloseChatModal} center classNames={{
          overlay: 'tavern-overlay',
          modal: 'tavern-modal',
        }}>
          <h1>Party time!</h1>
          <p>
            ...
            <br />
            <br />
            The old Wizard says, "Whoa there...watch yourself, gnome! This book is THE Adventurers Registry of Legend! It's said 
            ...
            <br />
            <br />
            "Oowwhhh shorry shir!" says the tipsy gnome. "I dii..diddnn...dddiddidnnn....was an axethdent. 'Tis my birthhday toodayy!"
            The Gnome leans closer to the Wizard and whispers "Ohh what're ye doin frienly wiz..um...wiz..." and she promptly passes out 
            as she falls out of her chair and onto the floor.
            <br />
            <br />
        ...
        <Modal open={openWizChat} onClose={onCloseWizChatModal} center classNames={{
          overlay: 'tavern-overlay',
          modal: 'tavern-modal',
        }}>
            ...
            <img src={wizardbook} id="wizard-book-image" />
              <p>
              The old wizard tells you a tale of intrigue and courage, of magic and mystery, of treasure and 
              toil, of monsters and men. Suddenly, you see a glow coming from the tome in his hands. 
              <br />
              <br />
              Finally, he says "Ahhh yes, so it seems the tome finds you worthy of 
              such a quest. Well now, let's see here, where we are to send you...hmm?" 
        ...
        <Modal open={openQuestChat} onClose={onCloseQuestChat} center classNames={{
          overlay: 'tavern-overlay',
          modal: 'tavern-modal',
        }}>
            <h1>Wonderful!</h1>
